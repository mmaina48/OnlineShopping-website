...
{
    public partial class AddSudCategory : System.Web.UI.Page
    {
        ...
        private void BindMainCategory()
        {
          ...
          { 
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                SqlCommand cmd = new SqlCommand("insert into tblSubCategories values('" + txtsubCategoryName.Text + "','" + ddlCategory.SelectedItem.Value + "')", con);
                con.Open();
                cmd.ExecuteNonQuery();
