<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="MicksDesignOnlineShop.Default" %>
            ...
            <div class="navbar navbar-default navbar-fixed-top"  role="navigation"> 
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-header" href="Default.aspx"><span><img alt="logo" src="Images/ProductImages/LOGO.png" height="40" /></span>MicksTecs</a>
                    </div>
                    <div class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <button id="btnCart" class="btn btn-primary navbar-btn" type="button">
                            ...
                            <li>
                                <asp:Button ID="btnSignOut" runat="server" Class="btn btn-default  navbar-btn" Text="SignOut" OnClick="btnSignOut_Click" />
                            </li>
