        ...
        protected void btnADD_Click(object sender, EventArgs e)
        {
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                if (fulmg01.HasFile)
                {
                    ...
                    fulmg01.SaveAs(SavePath + "\\" + txtPName.Text.ToString().Trim() + "01" + Extention);
                ...
                if (fulmg02.HasFile)
                {
                    ...
                    fulmg02.SaveAs(SavePath + "\\" + txtPName.Text.ToString().Trim() + "02" + Extention);
                ...
                if (!fulmg03.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fulmg03.PostedFile.FileName);
                    fulmg03.SaveAs(SavePath + "\\" + txtPName.Text.ToString().Trim() + "03" + Extention);
                ...
                if (!fulmg04.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fulmg04.PostedFile.FileName);
                    fulmg04.SaveAs(SavePath + "\\" + txtPName.Text.ToString().Trim() + "04" + Extention);
                ...
                if (!fulmg05.HasFile)
                {
                    ...
                    string Extention = Path.GetExtension(fulmg05.PostedFile.FileName);
                    fulmg05.SaveAs(SavePath + "\\" + txtPName.Text.ToString().Trim() + "05" + Extention);
